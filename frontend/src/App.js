  ...
  const customerBalanceHandler = async () => {
    try {
      if (window.ethereum) {
        ...
        let balance = await bankContract.checkCustomerBalance();
  ...
  return (
    ...
    <div className="">
      <main className="main-container">
        ...
        <section className="px-10 pt-5 pb-10 customer-section">
        ...
        {isBankerOwner && (
          <section className="bank-owner-section">
            <h2 className="px-10 py-4 text-xl font-bold border-b-2 border-indigo-500">
              Bank Admin Panel
            </h2>
            <div className="p-10">
              <form className="form-style">
      ...
      <footer className="w-full my-4 font-bold text-center text-white footer">
        <a href="https://github.com/AdwitM/BankDapp">
